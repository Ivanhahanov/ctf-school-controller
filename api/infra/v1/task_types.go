...
type TaskFile struct {
	// Source — это URL файла (например, s3://bucket/file)
	Source string `json:"source"`
}

// TaskCheck описывает скрипты или проверки состояния таски
...
type TaskSpec struct {
	...
	// Checks — проверки для валидации решения
	Checks []TaskCheck `json:"checks,omitempty"`
	// Env — переменные окружения, включая динамические флаги
...
// +kubebuilder:resource:path=task,scope=Cluster
